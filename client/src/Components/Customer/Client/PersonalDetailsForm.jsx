...
//       const mpNagarArea = data.find(item => item.area?.toLowerCase().includes("mp nagar") || item.name?.toLowerCase().includes("mp nagar"));
//       setFormData((prev) => ({
//         ...prev,
//         preferredMeetingArea: mpNagarArea ? mpNagarArea.area || mpNagarArea.name : data[0].area || data[0].name || "",
//       }));
//     } else {
//       setFormData((prev) => ({ ...prev, preferredMeetingArea: "Area not found" }));
//     }
//   } catch (error) {
//     console.error("Error fetching area data:", error);
//     setFormData((prev) => ({ ...prev, preferredMeetingArea: "Error fetching area" }));
//   }
// };
