...
const ProposedPlanFormForSuspect = ({ suspectId, suspectData, onSuspectCreated }) => {
  ...
  try {
    ...
    console.log("IdToUse", idToUse)
     ...
     const result = await dispatch(addProposedFinancialPlan({ suspectId :idToUse, formData }));
     if(result){
    setSavedPlans([]);
    setPlans([{
      createdDate: "",
